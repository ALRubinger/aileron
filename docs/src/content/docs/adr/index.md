...
- [ADR-0008: Action Exposure to Agents](/adr/0008-intent-matching) — MCP is the canonical action-exposure surface under both host launch and v4 sandbox launch (the sandbox-launch revival landed in ADR-0024). Generated HTTPS shims remain a complementary non-MCP-native CLI surface.
...
- [ADR-0020: v4 Connector Specs and Generated HTTPS Shims](/adr/0020-v4-connector-specs-and-shims) — *Proposed.* Connector packages provide machine-readable operation specs; Aileron uses them to render discovery and generated HTTPS shims for the sandbox runtime.
