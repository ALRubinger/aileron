...
> **Architecture:** part of the [Architecture](/pivot/architecture/) section of the Pivot strategy. See also [The Connector Model](/pivot/architecture/connector-model), [The Action Model](/pivot/architecture/action-model), and [How Intent Matches to Actions](/pivot/architecture/intent-matching).
