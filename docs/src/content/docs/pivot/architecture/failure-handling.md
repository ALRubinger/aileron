...
> **Architecture:** part of the [Architecture](/pivot/architecture/) section of the Pivot strategy. See also [The Action Model](/pivot/architecture/action-model), [How Intent Matches to Actions](/pivot/architecture/intent-matching), and [The User Channel](/pivot/architecture/user-channel).
