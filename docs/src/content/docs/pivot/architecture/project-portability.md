...
> **Architecture:** part of the [Architecture](/pivot/architecture/) section of the Pivot strategy. See also [The Action Model](/pivot/architecture/action-model), [Two Distribution Mechanics](/pivot/architecture/distribution-mechanics), and [Capability Binding UX](/pivot/architecture/capability-binding).
