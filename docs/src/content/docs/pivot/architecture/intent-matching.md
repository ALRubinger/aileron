...
> **Architecture:** part of the [Architecture](/pivot/architecture/) section of the Pivot strategy. See also [The Action Model](/pivot/architecture/action-model) and [Aileron Runtime](/pivot/runtime).
