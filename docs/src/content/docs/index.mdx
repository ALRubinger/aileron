...
Aileron ships a Slack connector today, and `aileron pp add <name>` or `aileron cli add <path>` turns any CLI you already use into a sandboxed capability your agent can call. Browse the full catalog in [Actions](/actions/google/).
