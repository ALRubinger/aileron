...
- [v4 Manual Acceptance Runbook](/development/v4-acceptance/) — the hands-on build, launch-in-a-container, and verify steps for the manual half of v4 acceptance (the macOS and Windows matrix cells from issue #747), plus the current verdict.
