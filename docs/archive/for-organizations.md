...
Aileron's v1 wedge is the individual developer — see [The Customer](/customer) for the four named personas. Organizations land here later, by design.
...
- [Pivot — Enterprise, Addressed Later](/enterprise-later) — why enterprise is intentionally out of the v1 pitch and which architectural commitments preserve it as a future path.
- [Pivot — Aileron Control](/control) — the governance surface enterprise tiers productize.
- [Pivot — The Business](/business) — Aileron Enterprise (Surface 7), Connector Certification (4), Insights (6), and Connector Studio (5) are the revenue surfaces aimed at this audience.
