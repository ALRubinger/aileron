...
> **Architecture:** part of the [Architecture](/architecture/) section of the Pivot strategy. See also [The Connector Model](/architecture/connector-model), [The Action Model](/architecture/action-model), and [The Capability Model](/architecture/capability-model).
