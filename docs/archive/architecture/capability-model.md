...
> **Architecture:** part of the [Architecture](/architecture/) section of the Pivot strategy. See also [The Connector Model](/architecture/connector-model) and [The Action Model](/architecture/action-model).
