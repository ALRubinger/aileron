...
> **Architecture:** part of the [Architecture](/architecture/) section of the Pivot strategy. See also [Install Consent: One Path](/architecture/install-consent), [The Capability Model](/architecture/capability-model), and [Project Portability](/architecture/project-portability).
