...
> **Architecture:** part of the [Architecture](/architecture/) section of the Pivot strategy. See also [The Connector Model](/architecture/connector-model), [The Capability Model](/architecture/capability-model), and [Capability Binding UX](/architecture/capability-binding).
