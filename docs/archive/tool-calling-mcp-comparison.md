...
> **Companion documents:** for the pitch and architectural insight, see [Overview](/); for the load-bearing decisions, see [Architecture](/architecture/). For the broader competitive scan beyond the two patterns compared here, see [Competitive Landscape](/competitive-landscape).
