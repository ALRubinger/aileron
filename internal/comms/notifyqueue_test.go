...
func TestNotifyQueue_PushAndMessages(t *testing.T) {
	...
	q.Push(comms.Message{ID: "1", Author: "Alice", Preview: "hello"})
	q.Push(comms.Message{ID: "2", Author: "Bob", Preview: "world"})
...
func TestNotifyQueue_Overflow(t *testing.T) {
	q := comms.NewNotifyQueue(3, nil)
	for i := 0; i < 5; i++ {
		q.Push(comms.Message{ID: string(rune('a' + i)), Preview: string(rune('a' + i))})
	}
...
func TestNotifyQueue_Len(t *testing.T) {
	...
	q.Push(comms.Message{ID: "1"})
	q.Push(comms.Message{ID: "2"})
	if q.Len() != 2 {
...
func TestNotifyQueue_UnreadCount(t *testing.T) {
	...
	q.Push(comms.Message{ID: "1"})
	q.Push(comms.Message{ID: "2"})
	q.Push(comms.Message{ID: "3", Read: true})
...
func TestNotifyQueue_Latest(t *testing.T) {
	...
	q.Push(comms.Message{ID: "1", Preview: "first"})
	q.Push(comms.Message{ID: "2", Preview: "second"})
...
func TestNotifyQueue_OnChange(t *testing.T) {
	...
	q := comms.NewNotifyQueue(10, func() {
		count.Add(1)
	})
...
func TestNotifyQueue_MessagesReturnsSnapshot(t *testing.T) {
	q := comms.NewNotifyQueue(10, nil)
	q.Push(comms.Message{ID: "1", Preview: "original"})
...
func TestNotifyQueue_AutoDraftCallbackFires(t *testing.T) {
	q := comms.NewNotifyQueue(10, nil)
	var got []string
	q.SetOnAutoDraft(func(msg comms.Message) {
		got = append(got, msg.ID)
	})

	q.Push(comms.Message{ID: "1", AutoDraft: true})
	q.Push(comms.Message{ID: "2", AutoDraft: false})
	q.Push(comms.Message{ID: "3", AutoDraft: true})
...
func TestNotifyQueue_FindByID(t *testing.T) {
	q := comms.NewNotifyQueue(10, nil)
	q.Push(comms.Message{ID: "1", Author: "Alice"})
	q.Push(comms.Message{ID: "2", Author: "Bob"})
...
func TestNotifyQueue_SetDraft(t *testing.T) {
	q := comms.NewNotifyQueue(10, nil)
	q.Push(comms.Message{ID: "1", Author: "Alice", Read: true})
...
func TestNotifyQueue_SetDraft_OnChangeCallback(t *testing.T) {
	var called int
	q := comms.NewNotifyQueue(10, func() { called++ })
	q.Push(comms.Message{ID: "1"})
...
func TestNotifyQueue_RecentByChannel(t *testing.T) {
	q := comms.NewNotifyQueue(10, nil)
	q.Push(comms.Message{ID: "1", Source: "slack", Channel: "#backend", AutoDraft: true, Timestamp: time.Now()})
	q.Push(comms.Message{ID: "2", Source: "slack", Channel: "#frontend", AutoDraft: true, Timestamp: time.Now()})
	q.Push(comms.Message{ID: "3", Source: "discord", Channel: "#backend", AutoDraft: true, Timestamp: time.Now()})
	...
	q2 := comms.NewNotifyQueue(10, nil)
	q2.Push(comms.Message{ID: "4", Source: "slack", Channel: "#backend", AutoDraft: false, Timestamp: time.Now()})
...
func TestNotifyQueue_RecentByChannel_ReturnsNewest(t *testing.T) {
	q := comms.NewNotifyQueue(10, nil)
	q.Push(comms.Message{ID: "old", Source: "slack", Channel: "#backend", AutoDraft: true, Timestamp: time.Now().Add(-1 * time.Minute)})
	q.Push(comms.Message{ID: "new", Source: "slack", Channel: "#backend", AutoDraft: true, Timestamp: time.Now()})
...
func TestNotifyQueue_DraftFieldsRoundtrip(t *testing.T) {
	q := comms.NewNotifyQueue(10, nil)
	q.Push(comms.Message{ID: "1", Draft: "pre-set draft", DraftFor: "orig-1"})
...
func TestNotifyQueue_QuietHoursSuppressesOnChange(t *testing.T) {
	...
	q.SetQuietHours(&config.QuietHoursConfig{
		Start: "20:00",
		End:   "08:00",
	})
	...
	q.Push(comms.Message{ID: "1", Priority: "normal"})
...
func TestNotifyQueue_QuietHoursHighPriorityBypasses(t *testing.T) {
	...
	q.Push(comms.Message{ID: "1", Priority: "high"})
...
func TestNotifyQueue_HighPriorityUnreadCount(t *testing.T) {
	q := comms.NewNotifyQueue(10, nil)
	q.Push(comms.Message{ID: "1", Priority: "normal"})
	q.Push(comms.Message{ID: "2", Priority: "high"})
	q.Push(comms.Message{ID: "3", Priority: "high", Read: true})
	q.Push(comms.Message{ID: "4", Priority: "high"})
...
func TestNotifyQueue_ConcurrentAccess(t *testing.T) {
	q := comms.NewNotifyQueue(100, nil)
...
func TestNotifyQueue_DraftPendingCount(t *testing.T) {
	...
	q.Push(comms.Message{ID: "3", AutoDraft: true, Draft: "reply", DraftFor: "3"})
